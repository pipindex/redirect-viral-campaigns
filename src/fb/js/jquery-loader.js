/*
 * Jquery Loader: CLAUDIO BALDI
 * $.loader.open(arg); 
 * $.loader.close(arg); 
 * $(dom).loader(arg);  
 */

//Script for Loading Spinner/Overlay 
    // include JQUERY Script and CSS style
    // <script src="http://www.academyft.com/dev3/js/jquery-loader.js">
    // <link rel="stylesheet" href="http://www.academyft.com/dev3/css/style-loader.css">
    // http://www.jqueryscript.net/loading/Simple-jQuery-Loading-Spinner-Overlay-Plugin-Loader.html
/*
    //include on your page!!
    jQuery(document).ready(function ($) {
        $('#moveDateCourse').on('submit', function () {
            $data = {
                    autoCheck: 32,
                    size: 32,
                    bgColor: '#FFFFFF',
